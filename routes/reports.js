...
router.get("/get/:reportId", validateReadReportAPI, asyncErrorHandler(async (req, res, next) => {
...
router.post("/create", validateCreateReportAPI, asyncErrorHandler(async (req, res, next) => {
...
router.patch("/update/:reportId", validateUpdateReportAPI, asyncErrorHandler(async (req, res, next) => {
...
router.post("/list", validateListReportAPI, asyncErrorHandler(async (req, res, next) => {
